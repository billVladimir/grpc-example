...
interface IUsersService_IGetUser
  extends grpc.MethodDefinition<users_pb.UserRequest, users_pb.User> {
...
interface IUsersService_ICreateUser
  extends grpc.MethodDefinition<users_pb.User, google_protobuf_empty_pb.Empty> {
...
interface IUsersService_IGetUsers
  extends grpc.MethodDefinition<google_protobuf_empty_pb.Empty, users_pb.User> {
...
export interface IUsersServer {
  ...
  >;
  getUsers: grpc.handleServerStreamingCall<
    google_protobuf_empty_pb.Empty,
    users_pb.User
  >;
}
...
export interface IUsersClient {
  getUser(
    ...
    callback: (error: grpc.ServiceError | null, response: users_pb.User) => void
  ...
  ): grpc.ClientWritableStream<users_pb.User>;
  createUser(
    metadata: grpc.Metadata,
    callback: (
      error: grpc.ServiceError | null,
  ...
  getUsers(
    ...
    options?: Partial<grpc.CallOptions>
  ): grpc.ClientReadableStream<users_pb.User>;
  getUsers(
    request: google_protobuf_empty_pb.Empty,
    metadata?: grpc.Metadata,
    options?: Partial<grpc.CallOptions>
